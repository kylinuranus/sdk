...
- (void)setCircleColor:(BOOL)today selected:(BOOL)selected		{
    [self setCircleColor:today selected:selected enabled:YES];
}
...
//    UIColor *labelColor = (today) ? [self textTodayColor] : [self textDefaultColor];
    ...
    UIColor *labelColor = enabled ? [self textDefaultColor] : [self textDisabledColor];
...
- (UIColor *)circleSelectedColor    {
    ...
    return [UIColor colorWithHexString:@"83A8FF"];
}
...
- (UIColor *)textDisabledColor    {
    if(_textDisabledColor == nil) {
        _textDisabledColor = [UIColor colorWithHexString:@"CFCFCF"];
    }
    ...
    return [UIColor colorWithHexString:@"CFCFCF"];
}
...
- (UIFont *)textDefaultFont    {
    if(_textDefaultFont == nil) {
        _textDefaultFont = [UIFont systemFontOfSize:14.0 weight:UIFontWeightBold];
    }
