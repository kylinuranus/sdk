...
- (void)setup {
    type = TPKeyboardAvoidingScrollViewTypeAdjust;
    _priorInsetSaved = NO;
...
- (void)keyboardWillShow:(NSNotification*)notification {
    ...
    self.contentInset = [self contentInsetForKeyboard];
    switch (type) {
        case TPKeyboardAvoidingScrollViewTypeAdjust:
        {
            ...
            break;
        case TPKeyboardAvoidingScrollViewManual:
        {
...
//            }
            ...
            CGPoint idealOffset = CGPointMake(0, offset);
