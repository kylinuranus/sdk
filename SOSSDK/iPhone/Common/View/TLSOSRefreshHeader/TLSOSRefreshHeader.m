//
//  TLSOSRefreshHeader.m
//  Onstar
//
//  Created by TaoLiang on 2017/10/18.
...
@implementation TLSOSRefreshHeader
...
- (void)prepare{
    ...
    NSString *path = [[NSBundle SOSBundle] pathForResource:@"pull_refresh_daytime_MA9_0" ofType:@"gif"];
...
//    imageView.image = [UIImage imageNamed:@"loading_top_common_375x80"];
//    [self addSubview:imageView];
//    [imageView mas_makeConstraints:^(MASConstraintMaker *make){
//        make.edges.equalTo(self);
//    }];

//    UIImageView *cloud = [UIImageView new];
//    cloud.image = [UIImage imageNamed:@"loading_top_car_375x80"];
//    [self addSubview:cloud];
//    [cloud mas_makeConstraints:^(MASConstraintMaker *make){
//        make.size.and.top.equalTo(imageView);
...
//        cloud.transform = CGAffineTransformMakeTranslation(-SCREEN_WIDTH * 2, 0);
...
//    }];
    ...
    car.image = [UIImage imageNamed:@"refresh_car_daytime"];
    [self addSubview:car];
