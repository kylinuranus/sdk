...
@interface LBSConfirmOrderConsigneeHeadView ()
...
@implementation LBSConfirmOrderConsigneeHeadView
...
- (UIButton *)editBtn {
    if (!_editBtn) {
        ...
        [_editBtn setTitleColor:UIColorHex(0x4E5059) forState:UIControlStateNormal];
        _editBtn.titleLabel.font = [UIFont fontWithName:@"PingFang-SC-Medium" size: 14];
