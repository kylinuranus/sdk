...
@interface SOSHorizontalMenuCollectionLayout ()


@end

@implementation SOSHorizontalMenuCollectionLayout
...
-(void)prepareLayout{
    ...
    NSInteger index = 0;
    CGFloat itemWidth = self.collectionView.frame.size.width /  self.columCount;
