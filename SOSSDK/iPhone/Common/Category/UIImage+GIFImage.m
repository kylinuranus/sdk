...

{
    ...
    NSString *imagePath = [[NSBundle SOSBundle] pathForResource:[NSString stringWithFormat:@"%@@%zdx", name, scale] ofType:@"gif"];
    
    if (!imagePath) {
        
        (scale + 1 > 3) ? (scale -= 1) : (scale += 1);
        
        imagePath = [[NSBundle SOSBundle] pathForResource:[NSString stringWithFormat:@"%@@%zdx", name, scale] ofType:@"gif"];
    ...
    if (imagePath) {
        ...
        imagePath = [[NSBundle SOSBundle] pathForResource:name ofType:@"gif"];
